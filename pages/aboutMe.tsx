...
export default function aboutMe() {
 ...
 <h1 className={classes.size}>  About Me  </h1>
                                        ...
                                        <p className={classes.aboutDescription}> I am a Front-end Developer with 12 years commercial experience, author of CSS3 Foundations, and graduate of Internet Technology. I create successful websites that are fast, easy to use, and built with best practices.
